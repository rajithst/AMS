...
<title>ANS | ASSET LOCATION CHANGE</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            ...
                            <small>Asset Location Change</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                            ...
                            <li class="active">
                                <i class="fa fa-file"></i> Location Change
                            </li>
                        </ol>

                        <!-- Form Begin -->
                        <form action="/AMS/index.php/admin/Assetdata/search_l" method="post">
                        ...
                        ?>
                        <form action="/AMS/index.php/admin/Assetdata/locationChange" method="post">
...
<script>
  ...
  $(document).ready(function(){
    ...
    $('#btn-submit').on('click',function(e){
      ...
      swal({
        title: "Are you sure?",
        text: "You want to update location of this asset!",
        type: "warning",
